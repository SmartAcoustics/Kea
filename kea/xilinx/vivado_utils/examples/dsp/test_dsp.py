...
import unittest
from kea.xilinx.vivado_utils.tests.base_hdl_test import (
    HDLTestCase, get_signed_intbv_rand_signal)
...
from .dsp import (
    DSP, DSP_OPMODE_MULTIPLY, DSP_OPMODE_MULTIPLY_ADD,
    DSP_OPMODE_MULTIPLY_ACCUMULATE,
    DSP_OPMODE_MULTIPLY_DECCUMULATE)
...
class DSPTestCase(HDLTestCase):
    ...
    def setUp(self):
        ...
        self.operations = {
            'multiply': DSP_OPMODE_MULTIPLY,
            'multiply_add': DSP_OPMODE_MULTIPLY_ADD,
            'multiply_accumulate': DSP_OPMODE_MULTIPLY_ACCUMULATE,
            'multiply_deccumulate': DSP_OPMODE_MULTIPLY_DECCUMULATE
        }
        ...
        test = DSP(**self.default_args)

        self.pipeline_registers = 3

class TestDSPInterface(DSPTestCase):
    '''The DSP should have a well defined interface, with careful
    ...
    def test_A_port_checked(self):
        ...
        '''
        self.do_port_check_intbv_test(DSP, 'A', 25, signed=True)
    ...
    def test_B_port_checked(self):
        ...
        Anything else should raise a ValueError.
        '''
        self.do_port_check_intbv_test(DSP, 'B', 18, signed=True)
    ...
    def test_C_port_checked(self):
        ...
        Anything else should raise a ValueError.
        '''
        self.do_port_check_intbv_test(DSP, 'C', 48, signed=True)
    ...
    def test_P_port_checked(self):
        ...
        Anything else should raise a ValueError.
        '''
        self.do_port_check_intbv_test(DSP, 'P', 48, signed=True)
    ...
    def test_opmode_port_checked(self):
        ...
        self.do_port_check_intbv_test(DSP, 'opmode',
    ...
    def test_clock_port_checked(self):
        ...
        Anything else should raise a ValueError.
        '''
        self.do_port_check_bool_test(DSP, 'clock')
    ...
    def test_clock_enable_port_checked(self):
        ...
        Anything else should raise a ValueError.
        '''
        self.do_port_check_bool_test(DSP, 'clock_enable')
    ...
    def test_reset_port_checked(self):
        ...
        Anything else should raise a ValueError.
        '''
        self.do_port_check_reset_test(DSP, 'reset', active=1, isasync=False)

class TestDSPSimulation(DSPTestCase):
    '''The DSP slice should implement various bits of functionality that
    ...
    def test_clock_enable(self):
        ...
        When clock_enable is False, the DSP should remain in an unchanged
...
class TestDSPVivadoVHDLSimulation(TestDSPSimulation):
    '''The tests of TestDSPSimulation should run under the Vivado
...
@unittest.skipIf(VIVADO_EXECUTABLE is None, 'Vivado executable not in path')
class TestDSPVivadoVerilogSimulation(TestDSPSimulation):
    '''The tests of TestDSPSimulation should run under the Vivado
    simulator using VHDL.
    '''
